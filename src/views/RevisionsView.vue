        ...
        <section class="sm:ml-64 custom-gradient md:p-4">
            <div class="mt-14">
                <div class="flex flex-col items-center justify-center p-4 py-10 text-center text-white">
                    <BackButton />
                    <h1 class="mb-4 text-[50px] font-bold">VOTRE MEMENTOS</h1>
                    <p class="mb-8 text-[20px]">Retrouvez ici tous les thèmes que vous révisez. Vous pouvez supprimer
                    ...
                    <div class="container px-4 mx-auto text-center sm:px-6">
                        ...
                        <div v-else>
                            ...
                            <div v-else class="col-span-1 text-2xl font-bold text-gray-700 md:col-span-2">
                                <p>Vous n'avez aucune révision en cours.</p>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <DeleteCrud :isVisible="isDeleteModalVisible" :deleteAllRevisions="true" @close="hideDeleteModal"
